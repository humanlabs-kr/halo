...
// Same reason as the retry suite: the processor pulls in a WASM image codec
// that only loads inside workerd.
...
const { storableAmount } = await import('../queues/receipt-analysis');
