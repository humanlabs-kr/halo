...
IF NOT A RECEIPT:
  → Return: qualityRate = 0, totalAmount = null, paymentMethod = null,
...
- Image is not a receipt → qualityRate = 0.
...
First, decide whether the image is actually a purchase receipt (see STEP 0 in the system prompt). If it is NOT a receipt, return qualityRate = 0 and do not invent merchant or amount data.
