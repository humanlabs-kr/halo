              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-[#6C6C6C]">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      line clearly labeled &quot;TOTAL&quot; (or equivalent) must
                      be visible
                    </span>
                  </li>
                </ul>
                <div className="mt-3 rounded-xl border-2 border-amber-200 bg-amber-50/80 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm text-amber-800/90">
                    The receipt <strong>issue date</strong> must be within the
                    last <strong>7 days</strong>. Receipts older than 7 days
                    cannot be claimed.
                  </p>
                </div>
              </div>
