/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc` (hash: cbca7503bc7041507483465a2bf9d133)
// Runtime types generated with workerd@1.20251109.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_RPC_URL: string;
		VITE_WEB_URL: string;
		VITE_LINK_VAULT_ADDRESS: string;
		VITE_CAMPAIGN_ADDRESS: string;
		VITE_WORLD_APP_ID: string;
		VITE_API_URL: string;
		VITE_MINIAPP_URL: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_PROJECT_ENV" | "VITE_RPC_URL" | "VITE_WEB_URL" | "VITE_LINK_VAULT_ADDRESS" | "VITE_CAMPAIGN_ADDRESS" | "VITE_WORLD_APP_ID" | "VITE_API_URL" | "VITE_MINIAPP_URL">> {}
}
