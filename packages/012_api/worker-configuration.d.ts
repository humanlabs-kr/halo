/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ed29be745d8fefcae80e190b6d64c25e)
// Runtime types generated with workerd@1.20251109.0 2025-09-25 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		PREDEFINED_CORS_ORIGINS: string;
		CORS_ORIGIN_BASE_DOMAINS: string;
		ALCHEMY_API_KEY: string;
		API_GATEWAY_TOKEN: string;
		OPENAI_API_KEY: string;
		SYNAPSE_PRIVATE_KEY: string;
		ADMIN_BEARER_TOKEN: string;
		SYNAPSE_ENCRYPTION_KEY: string;
		WORLD_APP_ID: string;
		API_COOKIE_DOMAIN: string;
		MINIAPP_URL: string;
		RECEIPT_R2_BUCKET: R2Bucket;
		RECEIPT_ANALYSIS_QUEUE: Queue;
		RECEIPT_SYNAPSE_UPLOAD_QUEUE: Queue;
		FLUENCE_OCR_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_ENV" | "JWT_SECRET" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "PREDEFINED_CORS_ORIGINS" | "CORS_ORIGIN_BASE_DOMAINS" | "ALCHEMY_API_KEY" | "API_GATEWAY_TOKEN" | "OPENAI_API_KEY" | "SYNAPSE_PRIVATE_KEY" | "ADMIN_BEARER_TOKEN" | "SYNAPSE_ENCRYPTION_KEY" | "WORLD_APP_ID" | "API_COOKIE_DOMAIN" | "MINIAPP_URL">> {}
}
