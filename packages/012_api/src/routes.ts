...
import { ReceiptStat } from './endpoints/receipt/stat';
import { ReceiptById } from './endpoints/receipt/get-by-id';
import { GetReceiptImage } from './endpoints/receipt/get-image';
...
v1Routes.get('/receipts/:receiptId/image/:receiptImageId', GetReceiptImage as any);
v1Routes.get('/receipt/stat', jwtAuthMiddleware, ReceiptStat as any);
v1Routes.get('/receipts/:receiptId', jwtAuthMiddleware, ReceiptById as any);
